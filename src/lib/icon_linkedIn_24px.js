import React from 'react';
 export function linkedIn24(props){
return(<svg className='iconoclass__svg iconoclass__fill' style={{position: 'absolute', top:'0', left:'0' }} preserveAspectRatio='xMidYMin' color={props.color ? props.color : ''} fill='currentColor' viewBox='0 0 24 24' width={props.size} height={props.size}>
